                ...
                <div class="card-body">
                    <form role="form" id="event_form">
                        <div class="row">
                          <div class="col-sm-12">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" placeholder="Enter Title..." id="event_title">
                            </div>
                          </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                              ...
                              <div class="form-group">
                                ...
                                <input type="date" id="event_date" class="form-control" placeholder="Date">
                             </div>
                            </div>
                            <div class="col-sm-4">
                                <!-- text input -->
                                <div class="form-group">
                                  ...
                                  <input type="time" id="event_time" class="form-control" placeholder="Time">
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            <div class="">
                                <label>Content</label>
                                <textarea class="textarea" id="event_desc" placeholder="Place some text here" ></textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="">
                                ...
                                <textarea class="textarea2" id="event_sch" placeholder="Place some text here" ></textarea>
                            </div>
                        </div>
                        <div class="row text-right"><button type="button" class="btn  btn-primary ml-auto pl-4 pr-4" id="save_event"><i class="fas fa-save"></i> Save & Publish</button></div>
                    </form>
                </div>
                <!-- /.card-body -->
            </div>
...
@section('script')
<script src="{{asset('admin/customFiles/add-events.js')}}"></script>
@endsection
